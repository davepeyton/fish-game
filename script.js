...
class Player {
    ...
    draw(){
        ...
        if (this.x >= mouse.x){
            ...
            ctx.drawImage(playerRight, this.frameX * this.spritewidht, this.frameY * this.
                spriteWidth, this.spriteWidth, this.spriteHeight, 0 - 60, 0 - 45, this.
                spriteWidth/4, this.spriteHeight/4);
        }
        ctx.restore();
    }
...
bubblePop2.src = 'bubble-single2.wav';
